            ...
            <Navbar className={ navbarClassName } fixedTop fluid>
                <Navbar.Header>
                    <Navbar.Brand>
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 191.797 191.797">
                ...
                <Navbar.Collapse>
                    <ul className="nav navbar-nav navbar-right">
                        ...
                        <NavDropdown eventKey={1} title={ <FormattedMessage id="language"/> } id="dropdown" onSelect={ this.handleSelect }>
                            ...
                            <MenuItem eventKey='pl'>
                                <span>POL</span>
                            </MenuItem>
                            <MenuItem eventKey='ua'>
                                <span>UKR</span>
                            </MenuItem>
                        </NavDropdown>
                    </ul>
